...
#define NUM_PRESERVE_STACK_QWORDS 32 // keep this an even number
...
std::unique_ptr<Hook> CreateTrampHook64_Advanced(BYTE* targetFunc, BYTE* destinationFunc, int offset = 0);
