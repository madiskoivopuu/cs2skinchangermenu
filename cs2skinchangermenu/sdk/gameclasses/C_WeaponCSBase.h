...
public:
	...
	NETVAR_WITH_OFFSET(CHandle<void*>, m_hStattrakEntity, "client.dll!C_CSWeaponBase->m_iNumEmptyAttacks", +4);
	NETVAR_WITH_OFFSET(CHandle<void*>, m_hNametagEntity, "client.dll!C_CSWeaponBase->m_iNumEmptyAttacks", +20);
